import { StringSerializer, StringInflection } from '../src/string-serializer';
...
module('StringSerializer', function (hooks) {
  ...
  module('disallowNull: false', function (hooks) {
    hooks.beforeEach(function () {
      serializer = new StringSerializer({ disallowNull: false });
    });
  ...
  module('disallowNull: true', function (hooks) {
    hooks.beforeEach(function () {
      serializer = new StringSerializer({ disallowNull: true });
    });
  ...
  module("inflections: ['dasherize']", function (hooks) {
    hooks.beforeEach(function () {
      serializer = new StringSerializer({ inflections: ['dasherize'] });
    });
  ...
  module("{ inflections: ['underscore'] }", function (hooks) {
    hooks.beforeEach(function () {
      serializer = new StringSerializer({ inflections: ['underscore'] });
    });
  ...
  module("{ inflections: ['camelize'] }", function (hooks) {
    hooks.beforeEach(function () {
      serializer = new StringSerializer({ inflections: ['camelize'] });
    });
  ...
  module("{ inflections: ['pluralize'] }", function (hooks) {
    hooks.beforeEach(function () {
      serializer = new StringSerializer({
  ...
  module("{ inflections: ['singularize'] }", function (hooks) {
    hooks.beforeEach(function () {
      serializer = new StringSerializer({
  ...
  module("{ inflections: ['pluralize', 'dasherize'] }", function (hooks) {
    hooks.beforeEach(function () {
      serializer = new StringSerializer({
  ...
  module("{ inflections: ['unrecognized'] }", function (hooks) {
    test('#serialize throws an error due to unrecognized inflection', function (assert) {
      serializer = new StringSerializer({
        inflections: ['unrecognized' as StringInflection]
      });
      assert.throws(() => {
        serializer.serialize('cow');
